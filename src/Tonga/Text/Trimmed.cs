...
public sealed class Trimmed : TextEnvelope
{
    ...
    public Trimmed(string text) : this(new TextMorph(text))
    { }
    ...
    public Trimmed(string text, char[] trimText) : this(new TextMorph(text), trimText)
    { }
    ...
    public Trimmed(IText text, Func<char[]> trimText) : base(
        new TextMorph(() => text.Str().Trim(trimText()))
    )
    { }
    ...
    public Trimmed(string text, string removeText) : this(new TextMorph(text), new TextMorph(removeText))
    { }
    ...
    /// <param name="text">text to trim</param>
    /// <param name="removeText">text that is removed from the text</param>
    public Trimmed(string text, IText removeText) : this(new TextMorph(text), removeText)
    { }
    ...
    /// <param name="text">text to trim</param>
    /// <param name="removeText">text that is removed from the text</param>
    public Trimmed(IText text, string removeText) : this(text, new TextMorph(removeText))
    { }
...
public static partial class TextSmarts
{
    ...
    public static TextMorph AsTrimmed(this string str) => new Trimmed(str);

    /// <summary>
    /// An <see cref="IText"/> trimmed (removed whitespaces) on both sides.
    /// </summary>
    /// <param name="text">text to trim</param>
    public static TextMorph AsTrimmed(this IText text) => new Trimmed(text);
    ...
    /// <param name="str">text to trim</param>
    /// <param name="trimText">text that trims the text</param>
    public static TextMorph AsTrimmed(this string str, char[] trimText) => new Trimmed(str, trimText);
    ...
    /// <param name="text">text to trim</param>
    /// <param name="trimText">text that trims the text</param>
    public static TextMorph AsTrimmed(this IText text, char[] trimText) => new Trimmed(text, trimText);
    ...
    /// <param name="text">text to trim</param>
    /// <param name="trimText">text that trims the text</param>
    public static TextMorph AsTrimmed(this IText text, Func<char[]> trimText) => new Trimmed(text, trimText);
    ...
    /// <param name="str">text to trim</param>
    /// <param name="removeText">text that is removed from the text</param>
    public static TextMorph AsTrimmed(this string str, string removeText) => new Trimmed(str, removeText);
    ...
    /// <param name="str">text to trim</param>
    /// <param name="removeText">text that is removed from the text</param>
    public static TextMorph AsTrimmed(this string str, IText removeText) => new Trimmed(str, removeText);
    ...
    /// <param name="text">text to trim</param>
    /// <param name="removeText">text that is removed from the text</param>
    public static TextMorph AsTrimmed(this IText text, string removeText) => new Trimmed(text, new TextMorph(removeText));
    ...
    /// <param name="ignoreCase">Trim by disregarding case.</param>
    /// <param name="removeText">text that is removed from the text</param>
    public static TextMorph AsTrimmed(this IText text, IText removeText, bool ignoreCase = false) =>
