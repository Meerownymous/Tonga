...
namespace Tonga.Enumerable
{
    ...
    public static class Logging
    {
        ...
        /// T is logged right after the underlying enumerator is moved.
        /// </summary>
        public static IEnumerable<T> Pipe<T>(IEnumerable<T> origin) => new Logging<T>(origin);

        /// <summary>
        /// Enumerable that logs object T when it is iterated.
        /// T is logged right after the underlying enumerator is moved.
        /// </summary>
        public static IEnumerable<T> Pipe<T>(IEnumerable<T> origin, Action<T> log) => new Logging<T>(origin, log);
    }
}
