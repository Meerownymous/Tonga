...
public static partial class EnumerableSmarts
{
    ...
    /// Enumerable which memoizes already visited items.
    /// </summary>
    public static IEnumerable<T> AsSticky<T>(this IEnumerable<T> source) => new Sticky<T>(source);

    /// <summary>
    /// Enumerable which memoizes already visited items.
    /// </summary>
    public static IEnumerable<T> AsSticky<T>(this Func<IEnumerable<T>> source) => new Sticky<T>(source);

    /// <summary>
    /// Enumerable which memoizes already visited items.
    /// </summary>
    public static IEnumerable<T> AsSticky<T>(this IEnumerator<T> source) => new Sticky<T>(source);

    /// <summary>
    /// Enumerable which memoizes already visited items.
    /// </summary>
    public static IEnumerable<T> AsSticky<T>(this Func<IEnumerator<T>> source) => new Sticky<T>(source);
}
