...
public sealed class WriterAsOutputStream : Stream
{
    ...
    /// </summary>
    private readonly Lazy<Decoder> decoder;
    ...
    /// <see cref="StreamWriter"/> as a writable <see cref="Stream"/>.
    /// </summary>
    public WriterAsOutputStream(StreamWriter writer, Func<Decoder> decoder) : base()
    {
        this.writer = writer;
    ...
    /// <see cref="StreamWriter"/> as a writable <see cref="Stream"/>.
    /// </summary>
    public void Write(int data) => this.Write(new byte[] { (byte)data }, 0, 1);
