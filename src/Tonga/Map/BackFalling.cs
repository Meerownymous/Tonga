...
namespace Tonga.Map
{
    ...
    public static partial class MapSmarts
    {
        ...
        /// <param name="map">Map returning existing values</param>
        /// <param name="fallback">Fallback generating missing values</param>
        public static IMap<Key, Value> AsBackFalling<Key, Value>(IMap<Key, Value> map, Func<Key, Value> fallback)
        ...
        /// <param name="map">Map returning existing values</param>
        /// <param name="fallback">Fallback generating missing values</param>
        public static IMap<Key, Value> AsBackFalling<Key, Value>(Func<IMap<Key, Value>> map, Func<Key, Value> fallback)
            => new BackFalling<Key, Value>(map, fallback);
    }
}
