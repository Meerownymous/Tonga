...
namespace Tonga.Enumerable
{
    ...
    public static class Ternary
    {
        ...
        /// </summary>
        /// <typeparam name="T"></typeparam>
        public static Ternary<T> Pipe<T>(IEnumerable<T> whenMatching, IEnumerable<T> whenNotMatching, bool condition) =>
        ...
        /// </summary>
        /// <typeparam name="T"></typeparam>
        public static Ternary<T> Pipe<T>(IEnumerable<T> whenMatching, IEnumerable<T> whenNotMatching, Func<bool> condition) =>
            new Ternary<T>(whenMatching, whenNotMatching, condition);
    }
}
