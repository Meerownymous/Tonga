...
namespace Tonga.Map
{
    ...
    /// </summary>
    public sealed class LazyMap2<Key, Value> : IDictionary<Key, Value>
    {
        private readonly IDictionary<Key, Func<Value>> map;
        ...
        /// This map is not sticky, so every retreval will result in a new computation of the value.
        /// </summary>
        public LazyMap2(params IPair<Key, Value>[] kvps) : this(AsEnumerable._(kvps), true)
        { }
        ...
        /// This map is not sticky, so every retreval will result in a new computation of the value.
        /// </summary>
        public LazyMap2(bool rejectBuildingAllValues, params IPair<Key, Value>[] kvps) : this(
        ...
        /// This map is not sticky, so every retreval will result in a new computation of the value.
        /// </summary>
        public LazyMap2(IEnumerable<IPair<Key, Value>> kvps, bool rejectBuildingAllValues = true)
        {
    ...
    public static class LazyMap2
    {
        ...
        /// A dictionary whose values are retrieved only when accessing them.
        /// </summary>
        public static LazyMap2<Key, Value> _<Key, Value>(
            params IPair<Key, Value>[] pairs
        ) => new LazyMap2<Key, Value>(pairs);
        ...
        public static LazyMap2<Key, Value> _<Key, Value>(
            ...
            new LazyMap2<Key, Value>(rejectBuildingAllValues, pairs);
        ...
        public static LazyMap2<Key, Value> _<Key, Value>(
            ...
            new LazyMap2<Key, Value>(pairs, rejectBuildingAllValues);
    }
}
