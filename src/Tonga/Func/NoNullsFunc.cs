...
namespace Tonga.Func
{
    ...
    public static class NoNullsFunc
    {
        ...
        /// </summary>
        /// <param name="fnc">func to check</param>
        public static IFunc<Out> _<Out>(System.Func<Out> fnc) => new NoNullsFunc<Out>(fnc);
        ...
        /// <param name="fnc">func to check</param>
        /// <param name="ex">Exception to throw</param>
        public static IFunc<Out> _<Out>(System.Func<Out> fnc, Exception ex) => new NoNullsFunc<Out>(fnc, ex);
        ...
        /// <param name="fnc">func to check</param>
        /// <param name="fallback">fallback value</param>
        public static IFunc<Out> _<Out>(System.Func<Out> fnc, Out fallback) => new NoNullsFunc<Out>(fnc, fallback);
        ...
        /// <param name="fnc">func to check</param>
        /// <param name="fallback">fallback value</param>
        public static IFunc<Out> _<Out>(System.Func<Out> fnc, System.Func<Out> fallback) => new NoNullsFunc<Out>(fnc, fallback);
